<template>
  <div>
    <button type="button" class="btn2 mb-3" @click="editModal(product.prodID)" data-bs-toggle="modal"
      :data-bs-target="'#dexampleModal' + product.prodID">
      Edit
    </button>
    <!-- Modal -->
    <div class="container">
      <div class="modal fade" :id="'dexampleModal' + product.prodID" tabindex="-1"
        :aria-labelledby="'aexampleModalLabel' + product.prodID" aria-hidden="true">
          ...
          <div class="modal-content bg-dark-subtle">
            ...
            <form>
              ...
              <div class="modal-body">
                ...
                <input type="text" v-model="editProduct.prodDesc" id="description" />
                <p class="title m-1">Price</p>
                <input type="text" id="amount" v-model="editProduct.price" />
