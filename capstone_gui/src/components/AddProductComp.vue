          ...
          <div class="modal-content" style="background-color: #F7D0AB; color: #92700f;">
            ...
            <form @submit.prevent="submitContentForm">
              <div class="modal-body">
                ...
                <input type="text" v-model="postProduct.category" id="category" />
                <p class="title">Description</p>
                <input type="text" v-model="postProduct.prodDesc" id="description" />
                <p class="title">Price</p>
                <input type="text" v-model="postProduct.price" id="price" />
                <p class="title">Quantity</p>
                <input type="text" v-model="postProduct.quantity" id="quantity" />
                <p class="title">Image Link</p>
                <input type="text" v-model="postProduct.prodUrl" id="imageLink" />
              </div>
